...
INSTALLED_APPS = [
    ...
    'base.apps.BaseConfig', #project should know about our new app(base)
    'rest_framework',
    'corsheaders',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR/'templates' #django should know about our templates folder
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT=BASE_DIR/'static/images'  #tells django where to upload pictures
